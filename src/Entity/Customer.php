...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom doit faire entre 1 et 255 caractères", max=255, maxMessage="Le nom doit faire entre 2 et 255 caractères")
     */
    private $lastName;
     ...
     * @Groups({"customers_read"})
     * @Assert\NotBlank(message="L'utilisatoire est obligatoire")
     */
    private $user;
